My report on take home exam
Name : Dessu Mideksa Gelan
second year bioinformatics student
ID:1998\14

Question 1: How many species are there in the current miRBase release?
Answer : there are Total number of 271 species in the current miRBase release.
...
Answer : There are 740 Total number of let-7 miRNAs in the current release of miRBase.


Question 3: what is the current version of miRBase?
Answer : the current version of miRBase is  22.1

#### Task: generate a plot to show which let miRNAs are present in each species. 
fig_question3_task2.png
...
fig_question5_task2.png




member of groups i work this exam with are:
Eyerusalem
Melak
Betselot
